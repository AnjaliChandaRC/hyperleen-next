...
const PrimaryHeading = ({
  ...
  return (
    <h2
      className={`xl:text-5xl lg:text-[44px] md:text-[40px] sm:text-4xl text-[30px] xl:!leading-[57.6px] md:!leading-[52px] sm:!leading-[48px] !leading-[42px] text-black font_gilroy_medium ${className}`}
    >
      {textName}
