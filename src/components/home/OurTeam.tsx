...
const OurTeam = () => {
  ...
  return (
    <div className="xl:py-[183px] py-[160px] 2xl:max-w-[1440px] mx-auto bg-ourTeam bg-cover md:bg-full bg-no-repeat bg-center relative z-30 overflow-hidden" id="team">
