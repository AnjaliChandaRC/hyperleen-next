        ...
        <div className="flex flex-wrap flex-row mx-[-12px] items-center">
          ...
          <div className="lg:w-[50%] w-full px-3 max-lg:flex max-lg:justify-center z-10 max-lg:items-center lg:pt-0 pt-10">
            <div className="relative">
              ...
              />
              {/* ====graph-image====== */}
              <div className="absolute xl:left-[69%] lg:left-[70%] max-lg:w-full md:left-[79%] left-[77%] max-sm:w-auto xl:-top-[15px] -top-[2%] xl:max-w-[191px] max-w-36 max-sm:max-w-[160px] lg:w-full lg:shadow-13xl shadow-14xl rounded-2xl">
                <Image
                  width={191}
                  height={241}
