...
const Improve = () => {
  ...
  return (
    <div className="xl:pt-[111px] pb-16 md:pb-20 xl:pb-[160px] 2xl:max-w-[1536px] mx-auto overflow-hidden">
          ...
          <div className="2xl:px-5 w-full lg:w-1/2 px-5 lg:pl-5 lg:pr-3 flex lg:justify-start justify-center">
            <div className="xl:max-w-[522px] md:max-w-[470px] sm:max-w-[420px] max-w-[268px] xl:h-[678px] md:h-[610px] sm:h-[550px] h-[350px] w-full relative">
              ...
              <div className="absolute sm:top-5 top-2 sm:left-5 left-2 w-full xl:max-w-[502px] md:max-w-[450px] sm:max-w-[400px] max-w-[260px] xl:h-[483px]">
                <div className="relative w-full border-[0.5px] border-blue rounded-2xl">
                  <Image
                    src="/assets/images/ai-trainer/webp/llm-image.webp"
                    width={502}
                    height={483}
                    alt="trainer-image"
          ...
          <div className="2xl:px-5 w-full lg:w-1/2 px-5 lg:pr-5 lg:pl-3 flex lg:justify-end justify-center lg:mt-0 md:mt-12 mt-10">
            <div className="lg:max-w-[558px] max-w-[740px] text-center lg:text-start">
              ...
              <Paragraph
                ...
                textName="Harness the power of human feedback to refine and optimize your Large Language Models. Our human-in-the-loop approach ensures your AI delivers precise, context-aware responses by incorporating detailed human insights and evaluations."
              />
              {/* accordion */}
              <div className="xl:mb-12 sm:mb-10 mb-6 lg:max-w-[558px] max-w-[600px] mx-auto w-full flex flex-col sm:gap-4 gap-3">
                ...
                {IMPROVE_DATA.map((value: AccordionData, index: number) => (
                  <div
                    key={index}
                    className={`flex text-start gap-4 rounded-lg lg:rounded-2xl w-full border-[0.5px] border-blue bg-white overflow-hidden ${
