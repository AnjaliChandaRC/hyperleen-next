            ...
            <div className='px-5'>
                ...
                <div className='container 2xl:max-w-[1360px] max-w-[1180px] mx-auto mt-10 bg-light_skyblue lg:py-11 py-8 md:px-6 px-4 rounded-2xl'>
                    ...
                    <div className='flex items-start lg:gap-8 md:gap-6 gap-4 lg:pt-[6px] pt-3'>
                        ...
                        <div>
                            <p className='text-grey max-w-[935px] md:text-xl font_gilroy_medium'>Data annotation is the process of labeling data to make it usable for machine learning algorithms. It's essential because accurately labeled data is critical for training models to understand and interpret real-world information.</p>
